...
\includegraphics[scale=0.70]{../tables/quality_img_numallstar.pdf}\\
\vspace{5mm}
\caption*{\small{(2) Traffic}}
\includegraphics[scale=0.70]{../tables/quality_traf_numallstar.pdf}
...
%%%%%%%%%%%
%%% Fig: HETERO EFFECTS WITH GAMES PLAYED AS ALTERNATE VARIABLE
%%%%%%%%%%%
...
\vspace{5mm}
\caption*{\small{(1) Images}}
\includegraphics[scale=0.70]{../tables/quality_img_gp.pdf}\\
\vspace{5mm}
\caption*{\small{(2) Traffic}}
\includegraphics[scale=0.70]{../tables/quality_traf_gp.pdf}
