...
global top "keep(`keepvar') star(+ 0.15 * 0.10 ** 0.05 *** 0.01) se ar2 nonotes coeflabels(`keepvar' "`varname'") booktabs order(`keepvar')  stats(, labels()) nomtitles nocons replace width(\hsize) postfoot(\end{tabular*} }) prefoot("") varwidth(50) eqlabels("") staraux"
